...
//
// Een method is een blok code dat je met een naam kunt aanroepen. Het codeblok wordt dan op de
// plek van de aanroep uitgevoerd. Bij de aanroep kun je via de parameters waardes meegeven 
// die in het codeblok van de method worden gebruikt.
//
...
//
// Methods kunnen ook niets teruggeven maar alleen iets uitvoeren. Zo'n method heet dan void (leeg).
...
//   waar hij naartoe moet. De method maakt het mogelijk dat je enkel het webadres ingeeft.
//
